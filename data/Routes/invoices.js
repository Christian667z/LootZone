...
router.post('/generate/:commandeId', requireAuth, requireMinRole('employe'), async (req, res) => {
    ...
    const siteUrl = process.env.SITE_URL || `https://${process.env.REPLIT_DEV_DOMAIN || 'asta-shops.com'}`;
...
router.get('/pdf/:commandeId', requireAuth, requireMinRole('employe'), async (req, res) => {
    ...
    doc.setFontSize(10); doc.setTextColor(240, 240, 240); doc.setFont('helvetica', 'bold');
    ...
    doc.setFontSize(11); doc.setTextColor(240, 240, 240); doc.setFont('helvetica', 'bold');
    ...
    doc.setFontSize(8); doc.setTextColor(136, 136, 136); doc.setFont('helvetica', 'bold');
    ...
    doc.setFontSize(10); doc.setTextColor(240, 240, 240); doc.setFont('helvetica', 'normal');
    ...
    doc.setFontSize(7); doc.setTextColor(136, 136, 136); doc.setFont('helvetica', 'normal');
